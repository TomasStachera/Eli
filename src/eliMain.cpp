...
actual_dir=f.GetPath();
    ...
    MenuINewProgram->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_NEW")),wxART_OTHER));
    ...
    MenuOpenProg->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_FILE_OPEN")),wxART_OTHER));
    ...
    MenuSaveProg->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_FILE_SAVE")),wxART_OTHER));
    ...
    MenuItem7 = new wxMenuItem(Menu5, idCompyCmd, _("Copy commands\tctrl+C"), _("Compy selected commands"), wxITEM_NORMAL);
    ...
    MenuISetBreak->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_ERROR")),wxART_OTHER));
    ...
    MenuIRemoveBreak->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_CROSS_MARK")),wxART_OTHER));
    ...
    MenuRemoveAllBreak->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_QUIT")),wxART_OTHER));
    Menu4->Append(MenuRemoveAllBreak);
    Menu4->AppendSeparator();
    MenuIDebug = new wxMenuItem(Menu4, idDebug, _("Debug\tF5"), _("Run debug mode"), wxITEM_NORMAL);
    MenuIDebug->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_FORWARD")),wxART_OTHER));
    Menu4->Append(MenuIDebug);
    MenuIStep = new wxMenuItem(Menu4, idStep, _("Step\tF6"), _("Run one step"), wxITEM_NORMAL);
    MenuIStep->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_REDO")),wxART_OTHER));
    ...
    MenuContinue->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_DOWN")),wxART_OTHER));
    ...
    MenuIStopDebuger->SetBitmap(wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_DELETE")),wxART_MENU));
    ...
    ToolBarItem4 = ToolBar1->AddTool(idToolRunTestPrg, _("Run"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_TICK_MARK")),wxART_TOOLBAR), wxNullBitmap, wxITEM_NORMAL, _("Run Test program"), _("Run Test program"));
    ToolBar1->AddSeparator();
    ToolBarItem5 = ToolBar1->AddTool(idToSetBreak, _("SetBreak"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_ERROR")),wxART_TOOLBAR), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_ERROR")),wxART_TOOLBAR), wxITEM_NORMAL, _("Set break"), _("Set break"));
    ToolBarItem6 = ToolBar1->AddTool(idTolRemovBreak, _("Clear"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_CROSS_MARK")),wxART_TOOLBAR), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_CROSS_MARK")),wxART_TOOLBAR), wxITEM_NORMAL, _("Remove break"), _("Remove break"));
    ToolBarItem7 = ToolBar1->AddTool(idTolRemoveAllBreak, _("Clear All"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_QUIT")),wxART_TOOLBAR), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_QUIT")),wxART_TOOLBAR), wxITEM_NORMAL, _("Remove all breaks"), _("Remove all breaks"));
    ToolBar1->AddSeparator();
    ToolBarItem8 = ToolBar1->AddTool(idToolDebug, _("Debug"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_FORWARD")),wxART_TOOLBAR), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_FORWARD")),wxART_TOOLBAR), wxITEM_NORMAL, _("Debug"), _("Debug"));
    ToolBarItem9 = ToolBar1->AddTool(idToolStep, _("Step"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_REDO")),wxART_TOOLBAR), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_REDO")),wxART_TOOLBAR), wxITEM_NORMAL, _("Run one step"), _("Run one step"));
    ToolBarItem10 = ToolBar1->AddTool(idToolContinue, _("Continue"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_DOWN")),wxART_TOOLBAR), wxNullBitmap, wxITEM_NORMAL, _("Continue"), _("Continue to the next break"));
    ToolBarItem11 = ToolBar1->AddTool(idToolStopDeb, _("Stop"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_DELETE")),wxART_TOOLBAR), wxNullBitmap, wxITEM_NORMAL, _("Stop debuger"), _("Stop debuger"));
    ToolBar1->AddSeparator();
    ToolBar1->AddSeparator();
    ToolBarItem12 = ToolBar1->AddTool(idRunLoop, _("Run loop"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_CDROM")),wxART_TOOLBAR), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_CDROM")),wxART_TOOLBAR), wxITEM_NORMAL, _("Run loop"), _("Run loop"));
    ToolBarItem13 = ToolBar1->AddTool(idStopLoop, _("Stop loop"), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_CROSS_MARK")),wxART_TOOLBAR), wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_CROSS_MARK")),wxART_TOOLBAR), wxITEM_NORMAL, _("Stop loop"), _("Stop loop"));
    ToolBar1->AddSeparator();
    ToolBar1->AddSeparator();
